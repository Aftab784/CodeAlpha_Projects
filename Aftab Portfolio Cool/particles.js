        ...
        var e = t(".main-navigation"),
            ...
            o = function() {
                t(document).on("click", ".open-contact", function(e) {
                    e.preventDefault(), t("body").addClass("is-contact-open"), Util.sendGAEvent("Contact", "Open Contac", !1), setTimeout(function() {
        ...
        var e = function(e) {
            ...
            _ = function() {
                if (Modernizr.mq("(min-width: 1024px)")) {
                    var e = t(".experiments-mask-reveal"),
                        i = e.find("span:first"),
                        n = e.find("span:last");
                    t(".case-study").addClass("is-hidden"), t(".-text-mask").addClass("is-hidden"), t(".single-work-intro-title").addClass("is-hidden"), t(".single-work-anim-text").addClass("is-hidden"), t(".single-work-first-anim-blocks").addClass("is-hidden"), t(".color-palette-container").addClass("is-hidden"), TweenLite.to(i, 0, {
                        y: "0",
                        ease: Power4.easeInOut
                    }), TweenLite.to(n, 0, {
                        y: "0",
            ...
            v = function() {
                if (Modernizr.mq("(min-width: 1024px)")) {
                    ...
                    }), inView(".sectio-text-mask").on("enter", function(e) {
                        t(e).removeClass("is-hidden")
...
window.jQuery || document.write('<sc src="js/jquery.min.js"><\\/script>');
